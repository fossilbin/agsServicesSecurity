...
String[] serverUrls = {
  ...
  "http://192.168.100.59:6080/arcgis/tokens/generateToken",
  "http://shibin:6080/arcgis/tokens/generateToken",
  "https://shibin:6443/arcgis/admin/generateToken",
  "http://shibin:6080/arcgis/admin/generateToken"//NOTE - no comma after the last item
};
%>
<%
try {
